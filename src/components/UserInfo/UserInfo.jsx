...
function UserInfo({ openUserInfo, setOpenUserInfo, setOpenEditUser }) {
  UserInfo.propTypes = {
    openUserInfo: PropTypes.bool,
    setOpenUserInfo: PropTypes.func,
    setOpenEditUser: PropTypes.func,
  }
  /* открытие модального окна для редакатирования данных поль-ля */
  const handleOpenEdirUser = () => {
    ...
    <div className={openUserInfo ? s.modal : s.modal_hidden}>
      <div className={s.wrapper}>
        <div className={s.header}>
          <Avatar sx={{ width: 56, height: 56, margin: 'auto' }} onClick={handleOpenEdirUser} />
          <h3>Name name</h3>
          <h5>email@com</h5>
        </div>
